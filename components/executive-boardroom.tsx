...
export function ExecutiveBoardroom({ sessionId }: ExecutiveBoardroomProps) {
  ...
  // Load agents from session data when it's available
  useEffect(() => {
    if (sessionData.activeAgents && sessionData.activeAgents.length > 0) {
      console.log('📋 Loading agents from session:', sessionData.activeAgents);
      setSelectedAgents(sessionData.activeAgents);
    }
  }, [sessionData.activeAgents]);
  ...
  const handleSendMessage = useCallback(async (message: string) => {
    ...
    console.log('🔄 Starting streaming discussion')
  ...
  }, [selectedAgents, sessionData.scenario, streamingState.messages, startStreamingDiscussion, sessionId, selectedDocuments])
    ...
    <div className="container mx-auto py-6 space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-3 space-y-6">
          ...
          {/* Document Context - Show when available - 📄 ENHANCED: Use streaming state */}
          {streamingState.documentContext && streamingState.documentContext.documentsUsed > 0 && (
            <DocumentContext
              documentsUsed={streamingState.documentContext.documentsUsed}
              citations={streamingState.documentContext.citations}
